...
def get_admin_settings_keyboard(user):
    ...
    buttons = [
        [
            Button.inline(
                text=i18n.t("keyboard.admin.plot", locale=user.locale), data=plot_data
            )
        ],
        [
            Button.inline(
...
def get_user_settings_keyboard(user):
    ...
    if user.notifications_enabled:
        notification_text = i18n.t(
            "keyboard.user.disable_notifications", locale=user.locale
        )
    else:
        notification_text = i18n.t(
            "keyboard.user.enable_notifications", locale=user.locale
        )
