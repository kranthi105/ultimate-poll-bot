...
def get_management_keyboard(poll):
    ...
    if poll.closed and not poll.results_visible:
        return [
            [
                Button.inline(
                    i18n.t("keyboard.delete", locale=locale), data=delete_payload
                )
            ]
        ]
    elif poll.closed:
        ...
        buttons = [
            [
                Button.inline(
                    i18n.t("keyboard.reset", locale=locale), data=reset_payload
                ),
                Button.inline(
                    i18n.t("keyboard.clone", locale=locale), data=clone_payload
                ),
            ],
            [
                Button.inline(
                ...
                Button.switch_inline(
                    ...
                    query=f"{poll.name} closed_polls",
                ),
            ],
            [
                Button.inline(
                    i18n.t("keyboard.reopen", locale=locale), data=reopen_payload
                )
            ],
        ]
        return buttons
    ...
    buttons = [
        [
            Button.switch_inline(
                i18n.t("keyboard.share", locale=locale), query=poll.name
            ),
        ],
        [
            Button.inline(i18n.t("keyboard.vote", locale=locale), data=vote_payload),
            Button.inline(
                i18n.t("keyboard.settings", locale=locale), data=option_payload
            ),
        ],
        [
            Button.inline(
            ...
            Button.inline(
                i18n.t("keyboard.close_poll", locale=locale), data=close_payload
            ),
        ],
    ]
...
def get_close_confirmation(poll):
    ...
    buttons = [
        [
            Button.inline(
                i18n.t("keyboard.permanently_close", locale=locale), data=payload
            )
        ],
